...
// ─────────────────────────── STATE ───────────────────────────
  ...
  `;
    ...
    function navItem(id, icon, label, badge, badgeColor = 'var(--red)') {
      ...
      setTimeout(() => {
        ...
        bars.forEach(bar => {
          bar.addEventListener('mouseenter', function (e) {
            ...
            setTimeout(() => { tooltip.style.opacity = '1'; tooltip.style.transform = 'translateY(0)'; }, 10);
      ...
      if (!window.hmHover) {
        window.hmHover = function (e, id, mod, status, count) {
          ...
          if (tt) {
            ...
            setTimeout(() => { tt.style.opacity = '1'; tt.style.transform = 'translateY(0)'; }, 10);
...
function buildTestCases() {
  ...
  `;
    ...
    function buildAllTestCasesTab() {
      ...
      const rows = data.map(tc => {
        ...
        const scriptObj = S.automationScripts.find(s => s.testCaseId == tc.id && s.module === tc.module);
        let iconSvg = '';
  ...
  <div class="section">
    ...
    <div class="tbl-wrap scrollable"><table>
      <thead><tr><th>ID</th><th>Test Case</th><th>Scenario</th><th>Module</th><th>Screen</th><th>Test Steps</th><th>Expected</th><th>Actual</th><th>Status</th><th>Severity</th><th>Evidence</th><th>Notes</th><th>Automation Status</th><th>Actions</th></tr></thead>
  ...
  <div class="section">
    ...
    <div style="display:flex; align-items:center; gap:16px;">ead>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Bug OS</title>
  <link rel="icon" type="image/png" href="header%20icon.png" />
  <script src="/cm-bundle.js">
...
function buildTestCases() {
    ...
    <div class="section-hdr">
      <div style="width: 100%;">
        ...
        <div style="display:flex; gap:10px; margin-top:16px; margin-bottom: 8px; align-items:center; flex-wrap:wrap;">
          <span style="font-size:12px; font-weight:700; color:var(--text3); margin-right:4px; text-transform:uppercase; letter-spacing:0.05em;">Supported Tech Stack:</span>
          
          <div class="tech-badge" style="padding:6px 12px; gap:8px;" title="Python">
            <svg style="width:16px; height:16px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128"><linearGradient id="python-original-a" gradientUnits="userSpaceOnUse" x1="70.252" y1="1237.476" x2="170.659" y2="1151.089" gradientTransform="matrix(.563 0 0 -.568 -29.215 707.817)"><stop offset="0" stop-color="#5A9FD4"/><stop offset="1" stop-color="#306998"/></linearGradient><linearGradient id="python-original-b" gradientUnits="userSpaceOnUse" x1="209.474" y1="1098.811" x2="173.62" y2="1149.537" gradientTransform="matrix(.563 0 0 -.568 -29.215 707.817)"><stop offset="0" stop-color="#FFD43B"/><stop offset="1" stop-color="#FFE873"/></linearGradient><path fill="url(#python-original-a)" d="M63.391 1.988c-4.222.02-8.252.379-11.8 1.007-10.45 1.846-12.346 5.71-12.346 12.837v9.411h24.693v3.137H29.977c-7.176 0-13.46 4.313-15.426 12.521-2.268 9.405-2.368 15.275 0 25.096 1.755 7.311 5.947 12.519 13.124 12.519h8.491V67.234c0-8.151 7.051-15.34 15.426-15.34h24.665c6.866 0 12.346-5.654 12.346-12.548V15.833c0-6.693-5.646-11.72-12.346-12.837-4.244-.
68 3.627-5.556m12.732.181c.212-.573.912-.871 1.485-.668.509.18.848.742.668 1.261-1.611 4.549-5.748 7.422-10.513 7.422H7.426c-.636 0-1.156-.52-1.156-1.156s.52-1.156 1.156-1.156c4.018 0 7.488-2.47 8.509-5.703m4.358-2.222-2.316.305v-2.01l-1.334.181c-.276-2.583-2.094-4.757-4.63-5.262v2.799l-2.003.264V1.75l-1.332.176c-.22.628-.867.925-1.455.702-.52-.197-.852-.771-.655-1.291C12.35-.119 18.067 1.139 19.866 5.864h2.247L21.84 7.5l2.45-.325z"/></svg>
            Selenium
          </div>

          <div class="tech-badge" style="padding:6px 12px; gap:8px;" title="Playwright">
            <svg style="width:16px; height:16px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="#2EAF5D" d="M2.936 1.63L3.102 1.54C6.398-1.597 12.005-2.314 17.65 6.643c5.644 8.956.848 15.655-2.333 17.355h.001c-3.181 1.701-8.788 2.418-14.432-6.539C-4.759 8.503.037 1.804 3.218.104h-.001L2.936 1.63z"/><path fill="#D23932" d="M12.981 18.006c-1.328-2.106-.707-4.898 1.385-6.236 2.092-1.337 4.862-.712 6.19 1.393 1.328 2.105.707 4.897-1.385 6.235s-4.862.712-6.19-1.392z"/></svg>
            Playwright
          </div>
        </div>
        </div>
  ...
  <div class="section">
    ...
    function buildAddTestCaseTab() {
      if (!initialDataReceived) return `<div class="empty">Waiting for server data...</div>`;
  ...
  `, () => {
    ...
    function retestPass(bugId) {
      ...
      openConfirm('Confirm Retest Pass',
        `Mark bug ${bugId} as PASSED?Test case "${b.testCase}" will be updated to PASS status and returned to Test Cases.`,
        () => {
          b.status = 'Verified';
          b.retestAt = now();
          b.retestCount++;
    ...
    function retestFail(bugId) {
      ...
      openConfirm('Confirm Retest Fail',
        `Mark bug ${bugId} as FAILED?This will re-open the bug and return it to the active Bug Reports queue.`,
        () => {
          b.status = 'Open';
          b.retestAt = now();
          b.retestCount++;
    ...
    function deleteTC(id, module) {
      ...
      openConfirm('Permanently Delete Test Case',
        `Delete "${tc.testCase}" (${id})?This will also remove any linked bugs and CANNOT be undone. The record will be completely removed from the system.`,
        () => {
    ...
    function deleteBug(id) {
      ...
      openConfirm('Permanently Delete Bug Report',
        `Delete bug "${id}" (${b.testCase})?This action is PERMANENT and cannot be undone. The bug record will be completely removed from the system.`,
        () => {
  ...
  `, () => submitEditTC());
    ...
    function submitEditTC() {
      ...
      const scenario = (document.getElementById('e-scenario') || { value: '' }).value.trim();
      const screen = (document.getElementById('e-screen') || { value: '' }).value.trim();
      ...
      const evidence = (document.getElementById('e-evidence') || { value: '' }).value.trim();
  ...
  `, () => {
    ...
    function buildImportTestCaseTab() {
      if (!initialDataReceived) { return `<div class="empty">Waiting for server data...</div>`; }
      if (!S.modules.length) { return `<div class="empty">Please add a module before importing test cases</div>`; }
